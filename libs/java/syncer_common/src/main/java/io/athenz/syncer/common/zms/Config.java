...
public class Config {
    ...
    static final String DEFAULT_DOMAIN_FETCH_THREADS = "1";
    ...
    public static final String SYNC_CFG_PARAM_DOMAIN_FETCH_THREADS = "domain_fetch_threads";
    ...
    static final String[] SYNC_CFG_PARAMS = {
            ...
            SYNC_CFG_PARAM_DOMAIN_FETCH_THREADS,
    ...
    private void mergeSyncConfigFile() {
        ...
        try {
            ...
            propertyMap.putIfAbsent(SYNC_CFG_PARAM_DOMAIN_FETCH_THREADS, DEFAULT_DOMAIN_FETCH_THREADS);
